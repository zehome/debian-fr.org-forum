          ...
          // END Topic solved
			...
			case 'reports_closed':
              ...
              // END Topic solved
							...
							'TOPIC_TITLE'	=> $row['topic_title']  . (($post_info['topic_solved'] && $post_info['topic_type'] != POST_GLOBAL) ? ' ' . (($post_info['forum_solve_text']) ? $post_info['forum_solve_text'] : $user->img('icon_topic_solved_list', 'TOPIC_SOLVED')) : ''))
						);
					}
					$db->sql_freeresult($result);
