...
// END Topic solved
	...
	if ($sql_where)
	{
		if ($show_results == 'posts')
		{
			...
			$sql = 'SELECT p.*, f.forum_id, f.forum_name, t.*, u.username, u.username_clean, u.user_sig, u.user_sig_bbcode_uid, u.user_colour, f.forum_solve_text, f.forum_solve_color
				FROM ' . POSTS_TABLE . ' p
